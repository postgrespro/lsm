...
CREATE FOREIGN TABLE item (id SERIAL, name VARCHAR(20), price NUMERIC(10,2), inventory INT, stime TIMESTAMP, flag BOOLEAN) SERVER lsm_server OPTIONS(storage 'column');
...
INSERT INTO item VALUES (DEFAULT, 'Name5', 30.00, 50, '2020-04-10 12:30:00', false);
